...
| `templates/demos.html` | New | `{% extends "page.html" %}`. Intro paragraph is `.demos-intro`-wrapped (display tier, DESIGN-v1.3 §1.3). Loops `extra.demos` / `extra.placards`. |
