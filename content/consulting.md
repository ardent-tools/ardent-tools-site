...
The practice's first engagement is a continuity and hardening program for a healthcare-analytics company - standing up CI on a Rust agent platform, closing an audit against it, and handing the operating runbook to their own engineer. That work product is theirs, so none of it appears here. A client gets named only with written permission.
