...
[[extra.ledger]]
name = "theatron"
gloss = "theatron · θέατρον - the seeing-place"
...
[[extra.ledger]]
name = "heurema"
gloss = "heurema · εὕρημα - a thing found"
...
[[extra.ledger]]
name = "koinon"
gloss = "koinon · κοινόν - that which is shared"
...
[[extra.ledger]]
name = "epitelesis"
gloss = "epitelesis · ἐπιτέλεσις - executing-to-completion"
...
[[extra.ledger]]
name = "zetesis"
gloss = "zetesis · ζήτησις - systematic inquiry"
...
[[extra.ledger]]
name = "typikon"
gloss = "typikon · τυπικόν - the book of order"
...
[[extra.ledger]]
name = "epistole"
gloss = "epistole · ἐπιστολή - a letter"
...
[[extra.ledger]]
name = "pinax"
gloss = "pinax · πίναξ - the tablet, the register"
one_liner = "A relational storage engine designed from scratch in Rust: multi-writer MVCC, per-page encryption, a causal changelog as a storage primitive. Design documents only, no implementation."
badge = "DESIGN PHASE"
...
[[extra.ledger]]
name = "mneme"
gloss = "mneme · μνήμη - memory as faculty"
one_liner = "A Datalog engine for facts, rules, and inference: content-addressed facts, supersede-based retraction, incrementally maintained views. Design documents only, no implementation."
badge = "DESIGN PHASE"
license = "PolyForm Shield 1.0.0"
...
[[extra.ledger]]
name = "dioptron"
gloss = "dioptron · δίοπτρον - the instrument through which one sees"
one_liner = "A specification for a web runtime where operator and agents share one capability surface: browsing, ingesting, querying, acting. Design documents only, no implementation."
badge = "DESIGN PHASE"
license = "AGPL-3.0-or-later"
