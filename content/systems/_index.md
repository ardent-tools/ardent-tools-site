...
The catalog groups by maturity, not chronology - flagship systems first, then the libraries they're built on, then what's still specification only. Every entry links to its own source and its own limits.
