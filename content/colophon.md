...
The authored site has no analytics, cookies, contact form, newsletter signup, remote font or script dependency, cadence promise on `/writing/`, inflated maturity label, or fabricated terminal output. Cloudflare Pages remains the delivery boundary. The [evidence register](/evidence/) lists every published cast; the systems without one show their recording plans only as plans, and no page requests a player asset without a real cast behind it.
