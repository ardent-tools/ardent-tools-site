...
a = "Depends on the role and scope. I am in a W2 search, with a part-time consulting engagement running through September 2026. Ask directly at [/contact/](/contact/) and I'll give a straight answer."
anchor = "availability"
...
a = "Yes, for live retrieval on a visitor's behalf. The [machine-readable systems catalog](/systems.json) and [career-claims receipt](/career-claims.json) are generated, and the gate fails if either disagrees with what the human pages render. This repository's AGENTS.md covers a cloned checkout. The [AI use policy](https://github.com/ardent-tools/ardent-tools-site/blob/main/AI-USE-POLICY.md) draws the line at bulk collection into a training corpus, which stays prohibited without written consent."
