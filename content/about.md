...
Most of what I've built since is a personal stack — the [full catalog](/systems/) is on this site — compiled, tested, and CI-verified before I call anything done. Two systems are the exception; they belong to my employer.
...
The second is a medical-code taxonomy engine built over eight days in March 2026 after upstream research and planning — a from-scratch Rust embedding pipeline over 301,000 medical codes.
